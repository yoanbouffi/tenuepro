...
const realisations = [
  // Restauration
  {
    id: 1, sector: 'Restauration', client: 'Restaurant côtier', location: 'Saint-Gilles-les-Bains',
  ...
  {
    id: 2, sector: 'Restauration', client: 'Restaurant casual', location: 'Saint-Pierre',
  ...
  {
    id: 3, sector: 'Restauration', client: 'Restaurant gastronomique', location: 'Saint-Denis',
  ...
  // Hôtellerie
  {
    id: 4, sector: 'Hôtellerie', client: 'Établissement hôtelier 4 étoiles', location: 'Saint-Gilles',
  ...
  {
    id: 5, sector: 'Hôtellerie', client: 'Villa & Spa', location: 'Hell-Bourg',
  ...
  // Sport
  {
    id: 6, sector: 'Sport', client: 'Club de football local', location: 'Saint-Pierre',
  ...
  {
    id: 7, sector: 'Sport', client: 'Club de trail', location: 'Cilaos',
  ...
  {
    id: 8, sector: 'Sport', client: 'Académie d\'arts martiaux', location: 'Le Tampon',
  ...
  // Santé
  {
    id: 9, sector: 'Santé', client: 'Établissement médical privé', location: 'Saint-Denis',
  ...
  {
    id: 10, sector: 'Santé', client: 'Cabinet médical', location: 'Saint-Paul',
  ...
  // Commerce
  {
    id: 11, sector: 'Commerce', client: 'Boutique de luxe', location: 'Saint-Denis',
  ...
  {
    id: 12, sector: 'Commerce', client: 'Grande surface de distribution', location: 'Saint-Benoît',
  ...
  // Associations
  {
    id: 13, sector: 'Associations', client: 'Association culturelle', location: 'Saint-Louis',
    description: '20 polos brodés pour les bénévoles de l\'association.',
    products: ['Polos brodés'], qty: 20,
    color: 'bg-yellow-600', emoji: '🤝',
    image: 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?auto=format&fit=crop&w=600&q=80',
  },
  {
    id: 14, sector: 'Associations', client: 'Club d\'entraide', location: 'Saint-Denis',
    description: '35 polos brodés pour les membres actifs de l\'association.',
    ...
    <div className="pt-16">
      ...
      <section className="bg-gray-900 py-16 text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <h1 className="text-4xl font-extrabold text-white mb-4">Nos projets récents</h1>
