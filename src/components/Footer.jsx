        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
              ...
              Qualité, rapidité et personnalisation pour toutes vos tenues de travail.
            </p>
            <div className="flex items-center gap-4 mt-6">
              <a
                ...
                className="w-9 h-9 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-[#7C3AED] transition-colors"
                aria-label="Facebook"
              >
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={to}>
                  <Link to={to} className="text-gray-400 hover:text-[#7C3AED] text-sm transition-colors">
                    {label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li className="flex items-start gap-2">
                <svg className="w-4 h-4 text-[#7C3AED] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:contact@tenuepro.re" className="hover:text-[#7C3AED] transition-colors">contact@tenuepro.re</a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4 text-[#7C3AED] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
